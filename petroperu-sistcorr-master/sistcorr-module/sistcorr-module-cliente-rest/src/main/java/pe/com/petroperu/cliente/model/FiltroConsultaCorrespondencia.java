...
public class FiltroConsultaCorrespondencia {
	...
	public FiltroConsultaCorrespondencia() {
		super();
		this.correlativo = "";
		this.codigoEstado = "0";
	...
	public FiltroConsultaCorrespondencia(String correlativo, String codigoEstado, String fechaRegistroDesde,
