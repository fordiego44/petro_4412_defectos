...
public class ExcelReporteComprobante {

	private static final String company = "PETRÓLEOS DEL PERÚ - PETROPERÚ S.A.";
	private static final String title = "REPORTE DE COMPROBANTES";
	...
	public ExcelReporteComprobante(Map<String, String> columns, List<Map<String, Object>> rows, String autor) {
		super();
	...
	public ExcelReporteComprobante(Map<String, String> columns, List<Map<String, Object>> rows, String autor, String title) {
		super();
		this.columns = columns;
		this.rows = rows;
		this.autor = autor;
...
//	        }
	...
	public void resizeColumns(SXSSFSheet sheet) {
		sheet.setColumnWidth(1, 6000);// Fecha Recepcion
		sheet.setColumnWidth(2, 6500);// Correlativo
		sheet.setColumnWidth(3, 5000);// Nro Batch
		sheet.setColumnWidth(4, 4000);// RUC
		sheet.setColumnWidth(5, 10000);// Razon Social
		sheet.setColumnWidth(6, 6000);// Tipo Comprobante
		sheet.setColumnWidth(7, 5000);// Nro Comprobante
		sheet.setColumnWidth(8, 6000);// Fecha Comprobante
		sheet.setColumnWidth(9, 3000);// Moneda
		sheet.setColumnWidth(10, 5000);// Estado
		sheet.setColumnWidth(11, 10000);// Depdendencia
	}
