...
public class DatosPrincipalesResponseSunat {
	...
	protected Integer ddp_secuen;

	@XmlElement(name = "ddp_tamano")
	...
	public void setDdp_secuen(Integer ddp_secuen) {
