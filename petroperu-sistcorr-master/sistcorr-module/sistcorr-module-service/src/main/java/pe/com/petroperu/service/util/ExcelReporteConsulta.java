...
public class ExcelReporteConsulta {

	private static final String company = "PETRÓLEOS DEL PERÚ - PETROPERÚ S.A.";
	private static final String title = "REPORTE DE BANDEJA DE SALIDA";
	...
	public ExcelReporteConsulta(Map<String, String> columns, List<Map<String, Object>> rows, String autor) {
		super();
	...
	public ExcelReporteConsulta(Map<String, String> columns, List<Map<String, Object>> rows, String autor, String title) {
		super();
		this.columns = columns;
		this.rows = rows;
		this.autor = autor;
	...
	public ByteArrayInputStream  buildReport() throws Exception {
		...
		SXSSFWorkbook wbs = new SXSSFWorkbook(book);//ticket 9000004115 optimizacion por el usuario de memoria dinamica de java
		wbs.setCompressTempFiles(true);
		try {
			SXSSFSheet sheet = (SXSSFSheet) wbs.createSheet("PETROPERÚ");
			sheet.setRandomAccessWindowSize(100);//mantener 100 filas en la memoria, las filas excedentes se descargarán en el disco//ticket 9000004115 optimizacion por el usuario de memoria dinamica de java
	        
			CreationHelper createHelper = wbs.getCreationHelper();
			//Sheet sheet = book.createSheet("PETROPERÚ");//se comento por el ticket 9000004115
			//ticket 9000004115 se cambio el uso de la variable book por wbs
