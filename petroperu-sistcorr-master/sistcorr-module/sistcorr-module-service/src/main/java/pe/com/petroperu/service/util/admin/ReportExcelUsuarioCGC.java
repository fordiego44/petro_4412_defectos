...
public class ReportExcelUsuarioCGC implements IReport<ByteArrayInputStream>{
	
	private List<UsuarioCgc> data;
	private Map<String, String> columns;
	private List<Map<String, Object>> values;
	private ByteArrayInputStream excelData;
	private String userCreate;
	
	public ReportExcelUsuarioCGC(List<UsuarioCgc> data,  String userCreate) {
		super();
		this.data = data;
	...
	public void process() {
		...
		try {
			...
			ExcelReporteConsulta excel = new ExcelReporteConsulta(columns, values, userCreate, "REPORTE CONSULTA USUARIO CGC");
