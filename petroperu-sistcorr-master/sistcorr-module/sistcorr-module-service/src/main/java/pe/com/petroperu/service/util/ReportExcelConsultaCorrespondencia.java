...
public class ReportExcelConsultaCorrespondencia  implements IReport<ByteArrayInputStream> {
	...
	public ReportExcelConsultaCorrespondencia(List<CorrespondenciaConsulta> data,  String userCreate) {
		super();
		this.data = data;
	...
	public void process() {
		try {
			...
			ExcelReporteConsulta excel = new ExcelReporteConsulta(columns, values, userCreate, "REPORTE DE CONSULTA DE CORRESPONDENCIAS");
