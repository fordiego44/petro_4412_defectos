...
public class ReemplazoRolesAnterioresConsultaDTO {
	...
	public ReemplazoRolesAnterioresConsultaDTO() {}
    
	public ReemplazoRolesAnterioresConsultaDTO(Long id_correspondencia, String correlativo, String dependenciaOriginadora,
...
public void setTipoCorrespondencia(String tipoCorrespondencia) {
	...
	public String toString() {
		return "CorrespondenciaConsultaDTO [id_correspondencia=" + id_correspondencia + ", correlativo=" + correlativo
			    ...
			    + ", fechaHasta=" + fechaUltActualizacion 
			    + ", fechaUltActualizacion=" + fechaHasta 
