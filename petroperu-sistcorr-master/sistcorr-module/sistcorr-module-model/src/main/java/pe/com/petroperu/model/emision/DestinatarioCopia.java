...
@Entity
@Table(name = "destinatario_copia")
public class DestinatarioCopia extends EntidadBase implements Serializable {
	private static final long serialVersionUID = -7189292246577874568L;
	@Id
