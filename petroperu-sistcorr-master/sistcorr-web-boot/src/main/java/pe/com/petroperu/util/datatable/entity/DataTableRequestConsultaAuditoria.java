...
public class DataTableRequestConsultaAuditoria extends DataTableRequest<FiltroConsultaCorrespondencia> {
	
	private FiltroConsultaAuditoria filtro;
	...
	public DataTableRequestConsultaAuditoria(HttpServletRequest request) {
		super(request);
		prepareRequestFilter(request);
	}

	public FiltroConsultaAuditoria getFiltro() {
		return filtro;
	}

	public void setFiltro(FiltroConsultaAuditoria filtro) {
		this.filtro = filtro;
	}
	
	private void prepareRequestFilter(HttpServletRequest request){
		this.filtro = new FiltroConsultaAuditoria();
		try {
