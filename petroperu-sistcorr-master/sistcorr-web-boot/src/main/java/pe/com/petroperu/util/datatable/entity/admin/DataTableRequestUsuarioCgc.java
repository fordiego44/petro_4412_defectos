...
public class DataTableRequestUsuarioCgc extends DataTableRequest<UsuarioCgc>{

	private UsuarioCgc filtro;
	private String columna;
	private String ordenDesc;
	public UsuarioCgc getFiltro() {
		return filtro;
	}
	public void setFiltro(UsuarioCgc filtro) {
		this.filtro = filtro;
	}
	...
	private void prepareRequestFilter(HttpServletRequest request) {
		...
		try{
			...
			String columnaOrden = Constante.COLUMNAS_CONSULTA_USUARIO_CGC[columnOrder - 2];
