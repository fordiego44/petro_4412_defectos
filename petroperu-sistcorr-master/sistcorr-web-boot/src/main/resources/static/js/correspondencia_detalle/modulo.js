var MODULO_CORRESPONDENCIA_DETALLE = (function(){
	...
	function ModuloCorrespondenciaDetalle(SISCORR_APP){
		...
		this.VISTA = {
			tabDatos: {
				...
				accordion:{
					datosAsignacion: {
						id: $("#btnDatosAsignacion"),
						acordion_head: $("#headingDatosAsigancion"),
						acordion_body: $("#collapseDatosAsignacion"),
						form: {
						}
					},
	...
	ModuloCorrespondenciaDetalle.prototype.procesarRechazarCorrespondencia = function(nroDocumento, correlativo, comentario){
		var ref = this;
		var token = ref.csrfToken.val(); 
		var header = ref.csrfHeader.val();
