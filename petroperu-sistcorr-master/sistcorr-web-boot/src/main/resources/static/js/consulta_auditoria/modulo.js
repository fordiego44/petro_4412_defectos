var MODULO_CONSULTA_CORRESPONDENCIA = (function(){
	...
	function ModuloConsultaCorrespondencia(SISCORR_APP){
		...
		this.EXPORT_EXCEL = '../app/consultar-correspondencia-auditoria-excel';
		// TICKET 9000004494
		this.URL_BASE_CONSULTAR_CORRESPONDENCIA = 'app';
		this.URL_BUSCAR_CORRESPONDENCIAS_CONSULTA_AUDITORIA = '../' + this.URL_BASE_CORRESPONDENCIA + '/correspondencia-auditoria/consultar';
		// FIN TICKET
