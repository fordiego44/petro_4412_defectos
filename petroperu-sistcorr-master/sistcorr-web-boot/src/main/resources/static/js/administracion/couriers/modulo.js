var MODULO_MANTENIMIENTO_COURIER = (function(){
	var instance;
	function ModuloMantenimientoCourier(SISCORR_APP){
		...
		this.compBusqueda = {
			...
			dataTableConsulta: $("#tablaCouriers"),
			btnBuscar: $("#btnBuscar"),
		...
		this.compModalDatos = {
				id : 0,
				codigoCourier: $("#textCodigo"),
				nombreCourier: $("#textNombre"),
				accion: ""
		...
		this.EXPORT_EXCEL = '../configuracion/consultarCouriersExcel';

		this.URL_BUSCAR_COURIERS = '../configuracion/consultarCouriers';
		this.URL_CRUD_COURIERS = '../configuracion/crudCouriers';
		
		
	};
	
	
	ModuloMantenimientoCourier.prototype.crudCouriers = function(parametros){
		var ref = this;
