var MODULO_MANTENIMIENTO_MOTIVO = (function(){
	var instance;
	function ModuloMantenimientoMotivo(SISCORR_APP){
		...
		this.compBusqueda = {
			...
			dataTableConsulta: $("#tablaMotivos"),
			btnBuscar: $("#btnBuscar"),
		...
		this.compModalDatos = {
				id : 0,
				codigoMotivo: $("#textCodigo"),
				nombreMotivo: $("#textNombre"),
				accion: ""
		...
		this.EXPORT_EXCEL = '../configuracion/consultarMotivosExcel';

		this.URL_BUSCAR_MOTIVOS = '../configuracion/consultarMotivos';
		this.URL_CRUD_MOTIVOS = '../configuracion/crudMotivos';
		
		
	};
	
	
	ModuloMantenimientoMotivo.prototype.crudMotivos = function(parametros){
		var ref = this;
	...
	ModuloMantenimientoMotivo.prototype.exportarExcel = function(filtro){
		var ref = this;
		var token = ref.csrfToken.val(); 
		var header = ref.csrfHeader.val();
		return $.ajax({
	...
	function createInstance(SISCORR_APP) {
        var object = new ModuloMantenimientoMotivo(SISCORR_APP);
        return object;
    }
    return {
