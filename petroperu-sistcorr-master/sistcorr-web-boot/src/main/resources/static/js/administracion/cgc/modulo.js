var MODULO_MANTENIMIENTO_CGC = (function(){
	var instance;
	function ModuloMantenimientoCgc(SISCORR_APP){
		...
		this.filtroBusqueda = {
			 filtroNomCGC: $("#textFiltroNombre"),
			 filtroCodLugar : $("#selFiltroLugar")
		};
		this.compModalDatos = {
				id : 0,
				codigoCGC: 		$("#textCodigo"),
				nombreCGC: 		$("#textNombre"),
				codigoLugar:	$("#sellugar"),
				tipoRotulo:		$("#textTipoRotulo"),
				mCodigoBarras:  $("#textCodigoBarra"),
				impresora:      $("#textImpresora"),
				tipoImpresora:  $("#textTipoImpresora"),
				mComputarizado: $("#textMarcaCgc"),
				codigoERP:      $("#textCodigoErp"),
				accion: ""
		...
		this.EXPORT_EXCEL = '../configuracion/consultarExcelCGC';

		this.URL_BUSCAR_CGC = '../configuracion/consultarCGC';
		this.URL_CRUD_MANTENIMIENTO = '../configuracion/crudCGC';
		
		
	};
	
	
	ModuloMantenimientoCgc.prototype.crudCgc = function(parametros){
		var ref = this;
	...
	ModuloMantenimientoCgc.prototype.exportarExcel = function(filtro){
		var ref = this;
		var token = ref.csrfToken.val(); 
		var header = ref.csrfHeader.val();
		return $.ajax({
	...
	function createInstance(SISCORR_APP) {
        var object = new ModuloMantenimientoCgc(SISCORR_APP);
        return object;
    }
    return {
