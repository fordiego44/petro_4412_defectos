var MODULO_MANTENIMIENTO_CGC_LUGAR_TRABAJO = (function(){
	var instance;
	function ModuloMantenimientoCgcLugarTrabajo(SISCORR_APP){
		...
		this.compBusqueda = {
			...
			dataTableConsulta: $("#tablaCgcLugarTrabajo"),
			btnBuscar: $("#btnBuscar"),
		...
		this.filtroBusqueda = {
			 filtroCgc     : $("#cmbFiltroCGC"),
			 filtroLugar   : $("#cmbFiltroLugar")
		};
		this.compModalDatos = {
				id : 0,
				codigoCgc 		: $("#cmbCGC"),
		...
		this.EXPORT_EXCEL = '../configuracion/consultarExcelCgcLugarTrabajo';

		this.URL_BUSCAR_CGC_LUGAR_TRABAJO = '../configuracion/consultarCgcLugarTrabajo';
		this.URL_CRUD_MANTENIMIENTO = '../configuracion/crudCgcLugarTrabajo';
		
	};
		
	ModuloMantenimientoCgcLugarTrabajo.prototype.crudCgcLugarTrabajo = function(parametros){
		var ref = this;
	...
	ModuloMantenimientoCgcLugarTrabajo.prototype.exportarExcel = function(filtro){
		var ref = this;
		var token = ref.csrfToken.val(); 
		var header = ref.csrfHeader.val();
		return $.ajax({
	...
	function createInstance(SISCORR_APP) {
        var object = new ModuloMantenimientoCgcLugarTrabajo(SISCORR_APP);
        return object;
    }
    return {
