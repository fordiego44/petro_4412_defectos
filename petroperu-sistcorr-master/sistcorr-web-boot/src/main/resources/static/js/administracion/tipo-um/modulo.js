var MODULO_MANTENIMIENTO_TIPO_UM = (function(){
	var instance;
	function ModuloMantenimientoTipoUM(SISCORR_APP){
		...
		this.EXPORT_EXCEL = '../configuracion/consultarTipoUMExcel';

		this.URL_BUSCAR_TIPO_UM = '../configuracion/consultarTipoUM';
		this.URL_CRUD_TIPO_UM = '../configuracion/crudTipoUnidadMatricial';
		
		
	};
	
	
	ModuloMantenimientoTipoUM.prototype.crudTipoUnidadMatricial = function(parametros){
		var ref = this;
	...
	ModuloMantenimientoTipoUM.prototype.exportarExcel = function(filtro){
		var ref = this;
		var token = ref.csrfToken.val(); 
		var header = ref.csrfHeader.val();
		return $.ajax({
	...
	function createInstance(SISCORR_APP) {
        var object = new ModuloMantenimientoTipoUM(SISCORR_APP);
        return object;
    }
    return {
