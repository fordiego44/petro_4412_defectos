...
var CONSULTA_REEMPLAZOS_VISTA = {
		...
		obtenerFiltros: function(){
			var ref = this;
			var _filtro = JSON.parse(sessionStorage.getItem("FILTRO_CONSULTA_ROLES_ANTERIORES")) || {};
			ref.filtro = _filtro;
		...
		buscarReemplazos: function(){
			...
			ref.searchReemplazos();
			sessionStorage.setItem("FILTRO_CONSULTA_ROLES_ANTERIORES", JSON.stringify(ref.filtro));
		},
				...
				ref.dataTableConsulta = ref.modulo.componentes.dataTableConsulta.DataTable({
			        ...
			        "columns": [
			        	{data: 'id_correspondencia', title: 'Ver', defaultContent: '', render: function(data, type, full){
			        		sessionStorage.setItem("bandeja_reemplazos", "rolesAnteriores");
