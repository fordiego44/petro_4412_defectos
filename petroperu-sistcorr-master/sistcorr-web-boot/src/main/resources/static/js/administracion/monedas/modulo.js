var MODULO_MANTENIMIENTO_MOMEDAS = (function(){
	var instance;
	function ModuloMantenimientoMoneda(SISCORR_APP){
		...
		this.compBusqueda = {
			...
			dataTableConsulta: $("#tablaMonedas"),
			btnBuscar: $("#btnBuscar"),
		...
		this.EXPORT_EXCEL = '../configuracion/consultarMonedaExcel';

		this.URL_BUSCAR_MONEDA = '../configuracion/consultarMoneda';
		this.URL_CRUD_MANTENIMIENTO = '../configuracion/crudMonedas';
		
		
	};
	
	
	ModuloMantenimientoMoneda.prototype.crudMonedas = function(parametros){
		var ref = this;
	...
	ModuloMantenimientoMoneda.prototype.exportarExcel = function(filtro){
		var ref = this;
		var token = ref.csrfToken.val(); 
		var header = ref.csrfHeader.val();
		return $.ajax({
	...
	function createInstance(SISCORR_APP) {
        var object = new ModuloMantenimientoMoneda(SISCORR_APP);
        return object;
    }
    return {
