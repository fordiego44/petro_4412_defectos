var MODULO_MANTENIMIENTO_PROVINCIA = (function(){
	var instance;
	function ModuloMantenimientoProvincia(SISCORR_APP){
		...
		this.compBusqueda = {
			...
			dataTableConsulta: $("#tablaProvincia"),
			btnBuscar: $("#btnBuscar"),
		...
		this.filtroBusqueda = {
			 filtroNomProvincia: $("#textFiltroNombre"),
			 filtroCodDepartamento : $("#selFiltroDepartamento")
		};
		this.compModalDatos = {
				id : 0,
				codigoProvincia: $("#textCodigo"),
				nombreProvincia: $("#textNombre"),
				codigoDepartamento: $("#selDepartamento"),
				accion: ""
		...
		this.EXPORT_EXCEL = '../configuracion/consultarProvinciaExcel';

		this.URL_BUSCAR_PROVINCIA = '../configuracion/consultarProvincia';
		this.URL_CRUD_MANTENIMIENTO = '../configuracion/crudProvincia';
		
		
	};
	
	
	ModuloMantenimientoProvincia.prototype.crudProvincia = function(parametros){
		var ref = this;
	...
	ModuloMantenimientoProvincia.prototype.exportarExcel = function(filtro){
		var ref = this;
		var token = ref.csrfToken.val(); 
		var header = ref.csrfHeader.val();
		return $.ajax({
	...
	function createInstance(SISCORR_APP) {
        var object = new ModuloMantenimientoProvincia(SISCORR_APP);
        return object;
    }
    return {
