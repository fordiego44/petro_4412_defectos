var MODULO_MANTENIMIENTO_NUMERADOR = (function(){
	var instance;
	function ModuloMantenimientoNumerador(SISCORR_APP){
		...
		this.compBusqueda = {
			...
			dataTableConsulta: $("#tablaNumerador"),
			btnBuscar: $("#btnBuscar"),
		...
		this.compModalDatos = {
				id : 0,
				codigoNumerador: $("#textCodigo"),
				ultimoCorrelativo: $("#textNombre"),
				accion: ""
		...
		this.EXPORT_EXCEL = '../configuracion/consultarNumeradorExcel';

		this.URL_BUSCAR_NUMERADOR = '../configuracion/consultarNumeradores';
		this.URL_CRUD_NUMERADOR = '../configuracion/crudNumeradores';
		
		
	};
	
	
	ModuloMantenimientoNumerador.prototype.crudNumerador = function(parametros){
		var ref = this;
	...
	ModuloMantenimientoNumerador.prototype.exportarExcel = function(filtro){
		var ref = this;
		var token = ref.csrfToken.val(); 
		var header = ref.csrfHeader.val();
		return $.ajax({
	...
	function createInstance(SISCORR_APP) {
        var object = new ModuloMantenimientoNumerador(SISCORR_APP);
        return object;
    }
    return {
