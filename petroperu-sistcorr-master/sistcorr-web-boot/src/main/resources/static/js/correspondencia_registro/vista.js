...
var CORRESPONDENCIA_EDICION_VISTA = {
		...
		iniciarCombosAutoCompletados: function(){
			var ref = this;
			var rmtLugarTrabajoSelect2 = ref.modulo.tabs.tabDatos.accordion.datosRemitente.compLugarTrabajo.select2({
				ajax: {
			...
			var rmtDependenciaSelect2 = ref.modulo.tabs.tabDatos.accordion.datosRemitente.compDependencia.select2({
				ajax: {
			...
			var destInternoTrabajoSelect2 = ref.modulo.tabs.tabDestinatario.internos.compLugarTrabajo.select2({
				ajax: {
				    url: ref.modulo.URL_BUSCAR_LUGARES,
				    data: function (params) {
				        var query = {
			...
			var desInternoDependenciaSelect2 = ref.modulo.tabs.tabDestinatario.internos.compDependencia.select2({
				ajax: {
				    url: ref.modulo.URL_BUSCAR_DEPENDENCIAS,
				    data: function (params) {
				        var query = {
			...
			var desExternoPais = ref.modulo.tabs.tabDestinatario.externos.compPais.select2({
				ajax: {
			...
			var desExternoDepartamento = ref.modulo.tabs.tabDestinatario.externos.compDepartamento.select2({
				ajax: {
			...
			var desExternoProvincia = ref.modulo.tabs.tabDestinatario.externos.compProvincia.select2({
				ajax: {
			...
			var desExternoDistrito = ref.modulo.tabs.tabDestinatario.externos.compDistrito.select2({
				ajax: {
			...
			var desExternoDepExterna = ref.modulo.tabs.tabDestinatario.externos.compDependenciaNac.select2({
				ajax: {
			...
			var copiaLugarTrabajoSelect2 = ref.modulo.tabs.tabCopias.compLugarTrabajo.select2({
				ajax: {
				    url: ref.modulo.URL_BUSCAR_LUGARES,
				    data: function (params) {
				        var query = {
			...
			var copiaDependenciaSelect2 = ref.modulo.tabs.tabCopias.compDependencia.select2({
				ajax: {
				    url: ref.modulo.URL_BUSCAR_DEPENDENCIAS,
				    data: function (params) {
				        var query = {
		...
		obtenerRegistroCorrespondencia: function(){
			...
			ref.correspondencia.fechaDocumento = ref.correspondencia.fechaDocumento + ' 00:00' ;
			...
			ref.correspondencia.jerarquia = ref.modulo.tabs.tabDatos.accordion.datosCorrespondencia.compJerarquia.is(':checked');
			ref.correspondencia.rutaAprobacion = ref.modulo.tabs.tabDatos.accordion.datosCorrespondencia.compRutaAprobacion.val();
		...
		inicializarCorrespondencia: function(){
			...
			ref.adjuntos = [];
			if(ref.correspondencia.idCorrespondencia > 0){
			...
			ref.modulo.registrarCorrespondencia(_correspondencia, ref.adjuntos)
				.then(function(respuesta){
					if(respuesta.estado == true){
						...
						console.log("Correspondencia Grabada.");
