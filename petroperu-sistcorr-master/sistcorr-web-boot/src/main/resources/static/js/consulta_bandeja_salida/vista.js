...
var CORRESPONDENCIA_CONSULTA_VISTA = {
		...
		componentes: {},
		filtro: {},
		storageVerDetalle: "VER_DETALLE",//TICKET 9000004710
		masFiltros: false,
		dataTable: null,
		...
		iniciarEventos: function(){
			...
			ref.modulo.componentes.btnBuscar.click(function(){
				...
				console.log("Eliminando order y page de sesión");
				console.log(sessionStorage.getItem("NroPag_CG"));
				console.log(sessionStorage.getItem("ColOrd_CG"));
			...
			if(ref.dataTableConsulta){
				...
				ref.dataTableConsulta = ref.modulo.componentes.dataTableConsulta.DataTable({
			        ...
			        "createdRow":function(row,data,index){
			        	var corresSeleccionado = sessionStorage.getItem("_itemSelec_ConsultaGeneralSalida");
				...
				/*ref.dataTableConsulta.on( 'page.dt', function () {
					...
					console.log("Actualizar Eventos Tabla On Page 2.1")
					ref.modSistcorr.procesar(true);
	        		setTimeout(function() {
						ref.updateEventosTabla();
						ref.modulo.btnDescargarDocumento = $(".btnDescargarDocumento");
				...
				ref.dataTableConsulta.on( 'order.dt', function () {
					...
					console.log("Actualizar Eventos Tabla On Order 2.1")
					ref.modSistcorr.procesar(true);
	        		setTimeout(function() {
						ref.updateEventosTabla();
						ref.modulo.btnDescargarDocumento = $(".btnDescargarDocumento");
				...
				ref.modulo.componentes.dataTableConsulta.on( 'page.dt', function () {
					var pagActual = ref.dataTableConsulta.page.info();
					sessionStorage.setItem("NroPag_CG", pagActual.page);
					console.log("Actualizar Eventos Tabla On Page 2")
	        		setTimeout(function() {
						ref.updateEventosTabla();
						ref.modulo.btnDescargarDocumento = $(".btnDescargarDocumento");
						ref.eventoDescargarDocumento();
				...
				ref.modulo.componentes.dataTableConsulta.on( 'order.dt', function () {
					...
					console.log("Actualizar Eventos Tabla On Order 2")
	        		setTimeout(function() {
						ref.updateEventosTabla();
						ref.modulo.btnDescargarDocumento = $(".btnDescargarDocumento");
						ref.eventoDescargarDocumento();
		...
		inicializarTablaConsultaDefecto: function(data){
			...
			if(ref.dataTableConsulta){
				...
				ref.modulo.componentes.dataTableConsulta.on( 'page.dt', function () {
					ref.dataTableConsulta.responsive.rebuild();
	        		ref.dataTableConsulta.responsive.recalc();
	        		console.log("Actualizar Eventos Tabla On Page");
	        		setTimeout(function() {
						ref.updateEventosTabla();
						ref.modulo.btnDescargarDocumento = $(".btnDescargarDocumento");
						ref.eventoDescargarDocumento();
		...
		updateEventosTabla: function(){
			var ref = this;
			console.log("Actualizando eventos de tabla");
			...
			for(var i = 0; i < allBtnsDetalle.length; i++){
				allBtnsDetalle[i].addEventListener('click', function(){
					...
					sessionStorage.setItem("_itemSelec_ConsultaGeneralSalida", this.dataset.id);
...
setTimeout(function() {
	...
	CORRESPONDENCIA_CONSULTA_VISTA.jefe = ES_JEFE;
